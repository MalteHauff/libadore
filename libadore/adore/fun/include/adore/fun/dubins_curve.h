	...
	namespace fun
	{
	   ...
	   */
       	class DubinsCurve
		{
            ...
            double plan(Node<3,double>* Start, Node<3,double>* End,adore::env::OccupanyGrid* og, adore::fun::CollisionCheckOffline* cco = nullptr, double HeadingResolutionRad = 0.0,DLR_TS::PlotLab::AFigureStub* figure =nullptr,bool PRINT =false)
            {
                init();
        ...
        void allCurvesToNodes(Node<3,double>* Start, Node<3,double>* End,adore::env::OccupanyGrid* og,adore::fun::CollisionCheckOffline* cco, double HeadingResolutionRad,DLR_TS::PlotLab::AFigureStub* figure)
        {
