...
namespace apps
{
    ...
    class GraphSearch
    {
        ...
        public:
            GraphSearch(ros::NodeHandle* parentnode, uint32_t height, uint32_t width)//, int8_t data,uint32_t height, uint32_t width)
            {
                vehicleLength = 3.2;
                vehicleWidth = 1.0; 
                ...
                OG = new adore::env::OccupanyGrid(height, width);
